...
KEEP extern const touchgfx::KerningNode kerning_Pretendard_SemiBold_12_4bpp[] FONT_KERNING_LOCATION_FLASH_ATTRIBUTE = {
    ...
    { 0x00B0, -2 },  // (First char = [0x00B0, degree], Second char = [0x002E, period], Kerning dist = -2)
    ...
    { 0x00B0, -1 },  // (First char = [0x00B0, degree], Second char = [0x0041, A], Kerning dist = -1)
    ...
    { 0x00B0, -1 },  // (First char = [0x00B0, degree], Second char = [0x004A, J], Kerning dist = -1)
    ...
    { 0x004C, -2 },  // (First char = [0x004C, L], Second char = [0x00B0, degree], Kerning dist = -2)
    { 0x004C, -1 },  // (First char = [0x004C, L], Second char = [0x00B0, degree], Kerning dist = -1)
};
